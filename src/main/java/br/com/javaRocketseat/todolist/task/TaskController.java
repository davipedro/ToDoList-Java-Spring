...
public class TaskController {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request){
        ...
        if (currentDate.isAfter(taskModel.getStartAt()) || currentDate.isAfter(taskModel.getEndAt())) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("A data de inicio e a data de término deve ser maior que a data atual");
        }
    ...
    @PutMapping("/{idTask}")
    public ResponseEntity put(@PathVariable UUID idTask, @RequestBody TaskModel taskModel, HttpServletRequest request){
